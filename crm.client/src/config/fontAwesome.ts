...
import { faChevronUp, faCircleUser, faUpRightAndDownLeftFromCenter,
    faHome, faRightFromBracket, faChevronLeft, faHouse, faPersonWalkingDashedLineArrowRight,
...
library.add(faChevronUp, faCircleUser, faUpRightAndDownLeftFromCenter, faHome, faRightFromBracket,
